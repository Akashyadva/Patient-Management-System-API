...
# check if patient with the same id already exists
    ...
    data[patient.id] = patient.model_dump(exclude =['id'])  # Ensure computed fields are calculated
...
# existing_patient_info -> pydantic model -> upadated bmi + verdict -> pydantic object -> dict
